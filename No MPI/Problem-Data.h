/*==============================================================================
Project: LiFe
Theme:  Theme: Surface Point Method (No MPI)
...
static string PD_MTX_File_hn;/*  File of numbers of hyperplanes that include surface point:
------------ begin of file -------------
nor noc // nor=m_sp (number of hyperplanes that include surface point); noc=1
n_1
...
n_{nor}
------------ end of file----------------*/